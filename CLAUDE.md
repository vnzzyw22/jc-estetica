...
- **Roadmap (aprovado):** dados → serviços reais → triagem → ficha da cliente → tratamentos/pacotes/sessões/evolução → financeiro/relatórios → dashboard → polimento. Etapas 0–2 (dados; site com tratamentos reais e CTAs de triagem) concluídas. Rota pública de tratamentos: `/tratamentos` (`/servicos` redireciona).
