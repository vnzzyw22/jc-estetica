...
const DB_MESSAGE: Record<string, string> = {
  ...
  invalid_status: "Essa ação não é possível no estado atual. Atualize a página.",
  ...
  duplicate_service: "O mesmo serviço foi escolhido duas vezes no pacote.",
  session_not_found: "Sessão não encontrada.",
  session_closed: "Essa sessão já foi encerrada.",
  treatment_not_active: "O tratamento precisa estar em andamento para agendar sessões.",
