...
const STEPS = [
  { title: "O que agendar", text: "Escolha o tratamento que você já conhece." },
      ...
      <div className="wrap py-[var(--spacing-section)]">
        <div className="grid gap-y-10 lg:grid-cols-12 lg:gap-x-6">
          <div className="lg:col-span-6">
            <h2 className="t-h1">Já sabe o que precisa? Agende direto.</h2>
            <p className="mt-6 max-w-[38ch] opacity-75">Para uma avaliação, um retorno ou um tratamento específico, sem troca de mensagens.</p>
          </div>
